...
{
    /// <summary>
    ///     Generate will produce a chunk of C# code that serves as the Event class of the AElf Contract. Events are used
    ///     internally to represent events that have happened during the execution of a smart contract.
    /// </summary>
    ...
    ///     replaces the C++ method
    ///     https://github.com/AElfProject/contract-plugin/blob/453bebfec0dd2fdcc06d86037055c80721d24e8a/src/contract_csharp_generator.cc#L148
    /// </summary>
    ...
    ///     replaces the C++ method
    ///     https://github.com/AElfProject/contract-plugin/blob/453bebfec0dd2fdcc06d86037055c80721d24e8a/src/contract_csharp_generator.cc#L152C1-L154C2
    /// </summary>
